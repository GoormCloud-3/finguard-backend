...
echo "LAMBDA_RDS_ROLE_ARN: " "$LAMBDA_RDS_ROLE_ARN"

if [[ -z "${SG_DAO:-}" || -z "${PRIVATE_SUBNET_1:-}" || -z "${PRIVATE_SUBNET_2:-}" || -z "${LAMBDA_RDS_ROLE_ARN:-}" || "${#PRIVATE_SUBNETS[@]}" -eq 0 ]]; then
